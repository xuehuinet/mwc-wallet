...
pub struct ProvableAddress {
	...
	//	/// Place holder for mwc713 and proof verify backward compatibility. Value is empty string
	//	pub domain: String,
	//	/// /// Place holder for mwc713 proof verify backward compatibility. Value is None
	//	pub port: Option<u16>,
}
